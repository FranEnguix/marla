    ...
    return pd.DataFrame(
        {
            ...
            "cpu_process_user_seconds_since_process_start": [1.0 + i for i in range(n)],
            "cpu_process_system_seconds_since_process_start": [0.5 + 0.1 * i for i in range(n)],
            "cpu_process_total_seconds_since_process_start": [1.5 + 1.1 * i for i in range(n)],
